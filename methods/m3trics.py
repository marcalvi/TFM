...
def build_training_arg_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        choices=["MLP", "pAM", "Di-pAM", "HealNet", "SMILe"],
    )
    parser.add_argument(
        "--dataset_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="1.0",
        help="Weight a for representation distillation loss in Di-pAM. Supports scalar or comma-separated list.",
    )
    parser.add_argument(
        "--distill_beta",
        type=str,
        default="0.3",
        help="Weight b for feature/logit distillation loss in Di-pAM. Supports scalar or comma-separated list.",
    )
