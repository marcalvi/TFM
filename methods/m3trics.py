...
def build_training_arg_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        choices=["MLP", "pAM", "pAM-Di-pAM", "MLP-Di-pAM", "Di-pAM", "HealNet", "SMILe"],
    )
    parser.add_argument(
        "--dataset_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="1.0",
        help="Weight a for representation distillation loss in pAM-Di-pAM / MLP-Di-pAM. Supports scalar or comma-separated list.",
    )
    parser.add_argument(
        "--distill_beta",
        type=str,
        default="0.3",
        help="Weight b for feature/logit distillation loss in pAM-Di-pAM / MLP-Di-pAM. Supports scalar or comma-separated list.",
    )
...
def _build_output_dir(
    ...
    if model_name_norm == "mlp":
        ...
        model_label = "PAM"
    elif model_name_norm == "pam_di_pam":
        model_label = "PAM-DI-PAM"
    elif model_name_norm in {"mlp_di_pam", "di_pam"}:
        model_label = "MLP-DI-PAM"
