...
# Local paths (MacBook Pro M3)
PROJECT_ROOT="/Users/marcalbesa/Desktop/TFM/git_exp/m3trics"
...
DATASET="mmProstate"
ENDPOINTS_CSV="endpoints_mmProstate.csv"
...
# Radiology modality
RADIO_NAME="radio"
RADIO_CSV="radiology_mmProstate.csv"
RADIO_DROP_COLS="study_date,time_to_diagnosis,source_file"

# Blood modality
BLOOD_NAME="blood"
BLOOD_CSV="blood_mmProstate.csv"
...
RADIO_REPORT_CSV="radioreports_mmProstate.csv"
...
# Methods
RUN_MODELS="pAM,ZI_MLP,HealNet,SMILe"
...
DISTILL_MODELS="${DISTILL_MODELS:-pAM,ZI_MLP}"
